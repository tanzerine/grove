...
export function integrationGuide(opts: {
  ...
  return [
    ...
    '',
    'Writing an article yourself? `create_draft` saves it to grove as a draft in the owner\'s review',
    'queue. It is never published by that call; it reaches `pull_new` only after the owner publishes it.',
    '',
