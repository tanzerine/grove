  ...
  return (
    <button
      ...
      style={solid
        ...
        : light
        ? { display: 'inline-flex', alignItems: 'center', gap: 7, border: '1px solid rgba(162,255,1,0.4)', background: 'rgba(162,255,1,0.12)', color: 'var(--gv-accent-ink)', fontFamily: 'inherit', fontSize: 12, fontWeight: 600, padding: '7px 13px', borderRadius: 9, cursor: 'pointer' }
