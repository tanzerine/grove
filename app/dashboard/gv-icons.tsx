...
const DEFS: Record<string, string[]> = {
  ...
  manager: ['M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6z', 'M9 12l2 2 4-4'],
  publish: ['M12 3v12', 'M7 8l5-5 5 5', 'M5 21h14'],
  arrow: ['M5 12h14', 'M13 6l6 6-6 6'],
  flag: ['M5 21V4', 'M5 4h12l-2 3.5 2 3.5H5'],
  copy: ['rect:8,8,13,13,2', 'M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1'],
  building: ['rect:5,3,14,18,1.5', 'M9 8h1', 'M14 8h1', 'M9 12h1', 'M14 12h1', 'M9 21v-4h6v4'],
  github: ['M9 19c-4.3 1.4-4.3-2.5-6-3m12 5v-3.5c0-1 .1-1.4-.5-2 2.8-.3 5.5-1.4 5.5-6a4.6 4.6 0 00-1.3-3.2 4.2 4.2 0 00-.1-3.2s-1.1-.3-3.5 1.3a12.3 12.3 0 00-6.2 0C6.7 2.8 5.6 3.1 5.6 3.1a4.2 4.2 0 00-.1 3.2A4.6 4.6 0 004.2 9.5c0 4.6 2.7 5.7 5.5 6-.6.5-.6 1-.5 2V21'],
};
