...
export default async function WritePage() {
  ...
  return (
    <>
      <DashHeader title={t('Write')} subtitle="a blank page — write it yourself, or start from Idea studio / SEO set on the right. Anything grove writes for you opens right here. Generate images from the toolbar, then pick when it publishes." />
