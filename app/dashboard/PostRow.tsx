    ...
    <div className="gv-prow" style={{ background: 'var(--gv-card)', border: '1px solid var(--gv-line)', borderRadius: 14, padding: '14px 16px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 13 }}>
        ...
        {score ? (
          ...
          <span title={t("No quality score — the manager's evaluation didn't run for this draft. It's held for your review by default.")} style={{ display: 'inline-flex', alignItems: 'center', gap: 4, flexShrink: 0, border: '1px dashed rgba(255,255,255,0.16)', borderRadius: 8, padding: '4px 9px' }}>
